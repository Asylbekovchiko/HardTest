...
class ArticleAdapter(
    ...
    private fun checkForUrlToImage(article: Article, articleViewHolder: ArticleViewHolder) {
        Glide.with(articleViewHolder.itemView.context).load(article.urlToImage).placeholder(R.drawable.ic_launcher_background).into(articleViewHolder.urlToImage)
    }
    ...
    inner class ArticleViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        ...
        val urlToImage: ImageView by lazy { view.urlToImage }
